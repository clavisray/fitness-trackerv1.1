...
function Homepage() {
    ...
    return (
        <div className="h-screen overflow-hidden">
            <main className="h-full overflow-y-scroll scroll-smooth">
                <section className="h-full">
                    <Header />

                    <div className="flex h-[75%] items-center justify-center px-4 md:px-20">
                        <div className="grid w-full max-w-6xl grid-cols-1 items-center gap-1 md:grid-cols-2">
                ...
                {/* DOWNLOAD */}
               <section className="h-full">
                    <div className="flex h-full items-center justify-center px-4 md:px-20">
                        ...
                        <div className="grid w-full max-w-6xl grid-cols-1 items-center gap-16 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p className="mt-2 max-w-xl text-base text-zinc-600 md:text-lg">
                                    Zabierz swój dziennik treningowy wszędzie tam, gdzie trenujesz.
                                    Zapisuj wyniki, śledź postępy i miej dostęp do wszystkich danych
                                    w jednym miejscu.
                                </p>
                            ...
                            {/* PRAWA STRONA */}
                            <div className="flex justify-center md:justify-end bg-blue-500">
                                prawa strona
                            </div>
                ...
                <section className='h-full bg-zinc-900 text-white'>
                    About
