...
function SignupPage() {
    return (
        <main className="min-h-screen bg-zinc-100 flex items-center justify-center px-4">
            <section className="w-full max-w-md rounded 3x-l bg-white p-8 shadow-xl">
                <Link to = "/">
                    <button className="mb-6 hover:bg-zinc-1000 cursor-pointer">
                ...
                <form className="flex flex-col gap-4">
                    <label className="mb-1 block text-sm font-medium">Imie</label>
                        <input type="imie" 
                        placeholder='Imie' 
